...
#-------------------------------------------------------
set CASE_NAME   = DE-Hai_pfth_nospin_hour
...
set WOUT_FREQ   = HOURLY         	# write output  file frequency: HOURLY/DAILY/MONTHLY/YEARLY
