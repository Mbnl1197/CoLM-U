...
setenv DAT_SRFDIR $DAT_ROOT/srf
setenv DAT_RTMDIR $DAT_ROOT/rtm/CaMaMap_glb_15min_CRU

# file name of forcing and surface data
setenv DAT_SRFNAM AR-SLu.MOD.nc                        # surface data filename
setenv DAT_URBNAM urban-data-filename                  # only for urban model
setenv DAT_ATMNAM AR-SLu_2010-2010_FLUXNET2015_Met.INT      # only for point case
...
#define	IGBP_CLASSIFICATION    5  ! USGS/IGBP/PFT/PC
